...
This program reads a bunch of log files generated by a program (and rotated by logrotate or another similar mecanism) and sends the interesting messages to stdout.
...
my $reflastfileread=read_files($conf{REGEXFILE},$reffilestoread);
