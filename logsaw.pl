...
=item -H, --show-filename: show log filenames in the output.

=item -n, --line-number: show line number of the entrey in the logfile.
...
=item * matching "postgresql\.log" (eg. postgresql.log, postgresql.log.1, postgresql.log.2.gz, ...)
